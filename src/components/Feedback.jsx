        ...
        <ThemeProvider theme={theme}>
            <div className="containerx">
                <div className="form-container">
                    ...
                    />
                    <p className="sing">Leave Your Feedback</p>
                    <FormControl>
                        ...
                        <Input type='comment' placeholder="Enter your comment" htmlSize = {40} width = "auto"
                               style = {{translate:"0% 140%",
                                   backgroundColor:"rgba(26,25,25,0.45)",
                                   border:"none",
                                   color:"white",
                                   height:"130px"
